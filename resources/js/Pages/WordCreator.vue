    ...
    <div class="max-w-2xl mx-auto p-6 bg-white rounded-lg shadow-lg mt-8">
        ...
        <form>
            ...
            <div class="flex items-center justify-between gap-4">
                <button v-if="mode != 'create'" type="submit" class="flex-1 bg-red-600 text-white py-2 px-4 rounded-lg shadow hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2" @click.prevent.stop="deleteButtonClicked">
                    Delete
                </button>
